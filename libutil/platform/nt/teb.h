...
typedef struct LIBUTIL_ALIGN(1) LIBUTIL_PACKED _LIBUTIL_NT_TEB32
{
    ...
    struct
    {
        ...
        libutil_u8                                                  SpareSameTebBits : 4;       /*+0x0FCA*/
    } SameTebFlags;
    ...
    libutil_u32                                                 SpareUlong0;                    /*+0x0FDC*/
...
typedef struct LIBUTIL_ALIGN(1) LIBUTIL_PACKED _LIBUTIL_NT_TEB64
{
    ...
    libutil_u64                                                 SystemReserved1[54];            /*+0x0110*/
    ...
    libutil_u8                                                  SpareBytes[24];                 /*+0x02D0*/
    ...
    struct
    {
        ...
        libutil_u8                                                  SpareSameTebBits : 4;       /*+0x17EE*/
    } SameTebFlags;
    ...
    libutil_u32                                                 SpareUlong0;                    /*+0x180C*/
...
#ifdef __cplusplus
    static_assert(sizeof(LIBUTIL_NT_TEB32) == 0xFE8, "sizeof(LIBUTIL_NT_TEB32) == 0xFE8");
    static_assert(sizeof(LIBUTIL_NT_TEB64) == 0x1820, "sizeof(LIBUTIL_NT_TEB64) == 0x1820");
#endif
