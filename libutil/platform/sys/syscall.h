...
#ifdef _WIN32
LIBUTIL_API LIBUTIL_IMPORT
libutil_i64 LibUtil_Syscall7(libutil_i32 ID, libutil_size Arg1, libutil_size Arg2, libutil_size Arg3, libutil_size Arg4, libutil_size Arg5, libutil_size Arg6, libutil_size Arg7);

LIBUTIL_API LIBUTIL_IMPORT
libutil_i64 LibUtil_Syscall8(libutil_i32 ID, libutil_size Arg1, libutil_size Arg2, libutil_size Arg3, libutil_size Arg4, libutil_size Arg5, libutil_size Arg6, libutil_size Arg7, libutil_size Arg8);
#endif
